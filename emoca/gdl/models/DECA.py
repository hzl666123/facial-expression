...
try:
    ...
    _emonet_available = True
except Exception:
    EmoNetLoss = None; create_emo_loss = None; create_au_loss = None
    _emonet_available = False
import numpy as np
...
class DECA(torch.nn.Module):
    ...
    def _setup_renderer(self):
        ...
        # Still set up mask/displacement buffers needed by decode
